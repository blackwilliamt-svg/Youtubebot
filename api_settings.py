...
API_FIELDS = [
    ...
    },
    {
        ...
        "label": "TikTok Dataset ID",
        "group": "Bright Data",
        "secret": False,
        "help": "Dataset id for the Bright Data TikTok Scraper API.",
    },
    {
        "key": "BRIGHTDATA_INSTAGRAM_DATASET_ID",
        "label": "Instagram Dataset ID",
        "group": "Bright Data",
        "secret": False,
        "help": "Dataset id for the Bright Data Instagram Scraper API.",
    },
    {
